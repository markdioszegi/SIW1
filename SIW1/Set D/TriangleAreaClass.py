...
class Triangle():
    ...
    def __init__(self, coords):
        self.coords = coords
        self.sides = self.calcSides(coords)
        self.area = self.calcArea(self.sides)

    def calcSides(self, coords):
        tmp = []
...
coords = inputCoords()
triangle0 = Triangle(coords)

print(triangle0.area)